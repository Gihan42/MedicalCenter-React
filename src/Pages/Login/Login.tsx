    ...
    return (
      <>
        <div className='h-screen bg-cover  'style={{ backgroundImage: `url(${backgroundImage})`}}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <div className="modal fade p-40" id="exampleModalToggle1" aria-hidden="true" aria-labelledby="exampleModalToggleLabel">
            <div className=" modal-dialog modal-dialog-centered backdrop-blur-3xl border-2  border-white rounded-3xl text-white "  id="exampleModalToggleDiv">
                <div className='modal-content  h-72 w-56 justify-center items-center rounded-3xl bg-transparent   text-emerald-50'>
